              ...
              children: [
                GestureDetector(
                  onTap: () {
                    print("object");
                    // onProgress();
                    rcontroller.showContainer();
                    // rcontroller.halprogress();
                  },
                  child: Container(
                    padding: EdgeInsets.symmetric(horizontal: 50, vertical: 10),
                    decoration:
                        BoxDecoration(color: Color.fromARGB(218, 56, 56, 56)),
                    child: Text(
                      "On Progress",
                      style: TextStyle(
                ...
                GestureDetector(
                  onTap: () {
                    print("object");
                    // onProgress();
                    rcontroller.halHistory();
                    rcontroller.showContainer2();
                  },
                  child: Container(
                    padding: EdgeInsets.symmetric(horizontal: 50, vertical: 10),
                    decoration:
                        BoxDecoration(color: Color.fromARGB(20, 95, 94, 94)),
                    child: Text(
                      "History",
                      style: TextStyle(
                          color: Colors.white, fontWeight: FontWeight.bold),
